...
public class {{clazz}}ServiceTest {

    {{clazz}}Service underTest;
    ...
    public void beforeEach(){
        ...
        underTest = new {{clazz}}Service(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        {{clazz}} excepted = new {{clazz}}();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<{{clazz}}> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        List<{{clazz}}> excepted = ImmutableList.of(new {{clazz}}().id("5sf76zf4raezf3z"), new {{clazz}}().id("5sf7sd4qsd46q"));
        Mockito.when(dao.findAll()).thenReturn(excepted);
        List<{{clazz}}> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        ArgumentCaptor<{{clazz}}> objectCaptor = ArgumentCaptor.forClass({{clazz}}.class);
        ...
        {{clazz}} objectCaptured = objectCaptor.getValue();
