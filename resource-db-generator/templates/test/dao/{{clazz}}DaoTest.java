...
import {{package}}.dao.{{clazz}}Db;
import {{package}}.dao.{{clazz}}Repository;
...
{{beforeEach}}
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses({{clazz}}.class, {{clazz}}Db.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        {{clazz}}Db objectDb = new {{clazz}}Db();
        ...
        {{clazz}}Db objectDbCaptured = ({{clazz}}Db) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any({{clazz}}Db.class));
