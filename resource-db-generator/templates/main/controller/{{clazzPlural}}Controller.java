...
/**
 * Controller implementing {{clazzPlural}}Service
 *
 * Auto-generated by {{generatorSignature}}
 * @author {{author}}
 */
@Component
@Named("{{clazzPlural}}Controller")
@ContextName("ResourceManager")
@Eager
@ComponentScan(basePackages = {"org.kathra.resourcemanager"})
public class {{clazzPlural}}Controller extends Abstract{{clazzPlural}}Controller {

    public {{clazzPlural}}Controller() {
