...
public interface ImplementationVersionMapper extends ResourceDbMapper {

    ImplementationVersionDb asImplementationVersionDb(ImplementationVersion in);
    ImplementationVersion asImplementationVersion(ImplementationVersionDb in);
}
