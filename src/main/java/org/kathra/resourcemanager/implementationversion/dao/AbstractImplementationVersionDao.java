 ...
 *
 * Auto-generated by resource-db-generator@1.1.1 at 2019-04-11T12:25:16.958Z
...
//init edge repositories 
    ...
    private void updateReferences(ImplementationVersion object) throws Exception {
        EdgeUtils.of(SourceRepositoryImplementationVersionEdge.class).updateReference(this.convertResourceToResourceDb(object), "sourceRepo", sourceRepositoryImplementationVersionEdgeRepository);
        EdgeUtils.of(ImplementationVersionImplementationEdge.class).updateReference(this.convertResourceToResourceDb(object), "implementation", implementationVersionImplementationEdgeRepository);
        EdgeUtils.of(ImplementationVersionApiVersionEdge.class).updateReference(this.convertResourceToResourceDb(object), "apiVersion", implementationVersionApiVersionEdgeRepository);
