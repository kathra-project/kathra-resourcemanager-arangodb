 ...
 *
 * Auto-generated by resource-db-generator@1.1.1 at 2019-04-12T13:51:02.284Z
...
//init edge repositories 
    ...
    private void updateReferences(User object) throws Exception {
        if (object.getGroups() != null) {
            ...
            EdgeUtils.of(UserAssignationEdge.class).updateList(new UserDb(object.getId()), groupsItemsToUpdate, userAssignationEdgeRepository);
        }
