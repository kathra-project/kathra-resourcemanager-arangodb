...
public interface LibraryApiVersionMapper extends ResourceDbMapper {

    LibraryApiVersionDb asLibraryApiVersionDb(LibraryApiVersion in);
    LibraryApiVersion asLibraryApiVersion(LibraryApiVersionDb in);
}
