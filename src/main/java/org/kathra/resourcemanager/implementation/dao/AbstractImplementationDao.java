 ...
 *
 * Auto-generated by resource-db-generator@1.1.1 at 2019-04-11T12:25:08.958Z
...
//init edge repositories 
    ...
    private void updateReferences(Implementation object) throws Exception {
        EdgeUtils.of(ImplementationComponentEdge.class).updateReference(this.convertResourceToResourceDb(object), "component", implementationComponentEdgeRepository);
        if (object.getVersions() != null) {
            ...
            EdgeUtils.of(ImplementationVersionImplementationEdge.class).updateList(new ImplementationDb(object.getId()), versionsItemsToUpdate, implementationVersionImplementationEdgeRepository);
        }
        EdgeUtils.of(SourceRepositoryImplementationEdge.class).updateReference(this.convertResourceToResourceDb(object), "sourceRepository", sourceRepositoryImplementationEdgeRepository);
        EdgeUtils.of(PipelineImplementationEdge.class).updateReference(this.convertResourceToResourceDb(object), "pipeline", pipelineImplementationEdgeRepository);
