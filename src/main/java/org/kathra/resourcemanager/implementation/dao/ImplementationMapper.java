...
public interface ImplementationMapper extends ResourceDbMapper {

    ImplementationDb asImplementationDb(Implementation in);
    Implementation asImplementation(ImplementationDb in);
}
