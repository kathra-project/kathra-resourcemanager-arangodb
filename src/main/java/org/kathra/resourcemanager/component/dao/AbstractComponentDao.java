...
/**
 * Dao service to manage Component using ComponentDb with ArangoRepository
 *
 * Auto-generated by resource-db-generator@1.0.1 at 2019-04-09T09:57:28.666Z
...
//init edge repositories 
    ...
    private void updateReferences(Component object) throws Exception {
        if (object.getVersions() != null) {
            ...
            EdgeUtils.of(ComponentApiVersionEdge.class).updateList(new ComponentDb(object.getId()), versionsItemsToUpdate, componentApiVersionEdgeRepository);
        }
        if (object.getLibraries() != null) {
            ...
            EdgeUtils.of(LibraryComponentEdge.class).updateList(new ComponentDb(object.getId()), librariesItemsToUpdate, libraryComponentEdgeRepository);
        }
        if (object.getImplementations() != null) {
            ...
            EdgeUtils.of(ImplementationComponentEdge.class).updateList(new ComponentDb(object.getId()), implementationsItemsToUpdate, implementationComponentEdgeRepository);
        }
        EdgeUtils.of(SourceRepositoryComponentEdge.class).updateReference(this.convertResourceToResourceDb(object), "apiRepository", sourceRepositoryComponentEdgeRepository);
