...
public interface CatalogEntryPackageMapper extends ResourceDbMapper {

    CatalogEntryPackageDb asCatalogEntryPackageDb(CatalogEntryPackage in);
    CatalogEntryPackage asCatalogEntryPackage(CatalogEntryPackageDb in);
}
