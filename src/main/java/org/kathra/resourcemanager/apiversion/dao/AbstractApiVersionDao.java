 ...
 *
 * Auto-generated by resource-db-generator@1.0.1 at 2019-04-09T15:31:11.803Z
...
//init edge repositories 
    ...
    private void updateReferences(ApiVersion object) throws Exception {
        EdgeUtils.of(ComponentApiVersionEdge.class).updateReference(this.convertResourceToResourceDb(object), "component", componentApiVersionEdgeRepository);
        if (object.getLibrariesApiVersions() != null) {
            ...
            EdgeUtils.of(LibraryApiVersionApiVersionEdge.class).updateList(new ApiVersionDb(object.getId()), librariesApiVersionsItemsToUpdate, libraryApiVersionApiVersionEdgeRepository);
        }
        if (object.getImplementationsVersions() != null) {
            ...
            EdgeUtils.of(ImplementationVersionApiVersionEdge.class).updateList(new ApiVersionDb(object.getId()), implementationsVersionsItemsToUpdate, implementationVersionApiVersionEdgeRepository);
        }
    ...
    public ApiVersion convertResourceDbToResource(ApiVersionDb object) {
        return mapper.asApiVersion((ApiVersionDb) new LeanResourceDbUtils().leanResourceDb(object));
    }
