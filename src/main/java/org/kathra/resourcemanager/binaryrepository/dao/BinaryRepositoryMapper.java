...
public interface BinaryRepositoryMapper extends ResourceDbMapper {

    BinaryRepositoryDb asBinaryRepositoryDb(BinaryRepository in);
    BinaryRepository asBinaryRepository(BinaryRepositoryDb in);
}
