 ...
 *
 * Auto-generated by resource-db-generator@1.1.1 at 2019-04-12T13:50:55.972Z
...
//init edge repositories 
    ...
    private void updateReferences(Group object) throws Exception {
        if (object.getMembers() != null) {
            ...
            EdgeUtils.of(GroupAssignationEdge.class).updateList(new GroupDb(object.getId()), membersItemsToUpdate, groupAssignationEdgeRepository);
        }
        EdgeUtils.of(GroupGroupEdge.class).updateReference(this.convertResourceToResourceDb(object), "parent", groupGroupEdgeRepository);
