 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T12:41:49.143Z
...
public class ImplementationDaoTest {
    ...
    public void beforeEach(){
		underTest.implementationComponentEdgeRepository = implementationComponentEdgeRepository;
		underTest.implementationVersionImplementationEdgeRepository = implementationVersionImplementationEdgeRepository;
		underTest.implementationBinaryRepositoryEdgeRepository = implementationBinaryRepositoryEdgeRepository;
		underTest.sourceRepositoryImplementationEdgeRepository = sourceRepositoryImplementationEdgeRepository;
		underTest.pipelineImplementationEdgeRepository = pipelineImplementationEdgeRepository;
		underTest.implementationCatalogEntryEdgeRepository = implementationCatalogEntryEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(Implementation.class, ImplementationDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        ImplementationDb objectDb = new ImplementationDb();
        ...
        ImplementationDb objectDbCaptured = (ImplementationDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(ImplementationDb.class));
