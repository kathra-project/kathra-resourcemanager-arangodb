 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T18:47:39.854Z
 * @author jboubechtoula
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class ApiVersionDaoTest {

    @InjectMocks
    ApiVersionDao underTest;
    ...
    public void beforeEach(){
		underTest.componentApiVersionEdgeRepository = componentApiVersionEdgeRepository;
		underTest.libraryApiVersionApiVersionEdgeRepository = libraryApiVersionApiVersionEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(ApiVersion.class, ApiVersionDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        ApiVersionDb objectDb = new ApiVersionDb();
        ...
        ApiVersionDb objectDbCaptured = (ApiVersionDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(ApiVersionDb.class));
