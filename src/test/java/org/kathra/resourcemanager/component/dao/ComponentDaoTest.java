 ...
 *
 * Auto-generated by resource-db-generator@1.3.0 at 2020-02-06T20:56:13.031Z
...
public class ComponentDaoTest {
    ...
    public void beforeEach(){
		...
		underTest.sourceRepositoryComponentEdgeRepository = sourceRepositoryComponentEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(Component.class, ComponentDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        ComponentDb objectDb = new ComponentDb();
        ...
        ComponentDb objectDbCaptured = (ComponentDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(ComponentDb.class));
