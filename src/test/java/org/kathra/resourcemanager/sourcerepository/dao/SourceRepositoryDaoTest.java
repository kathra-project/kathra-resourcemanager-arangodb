...
public class SourceRepositoryDaoTest {

    @InjectMocks
    SourceRepositoryDao underTest;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(SourceRepository.class, SourceRepositoryDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        SourceRepositoryDb objectDb = new SourceRepositoryDb();
        ...
        SourceRepositoryDb objectDbCaptured = (SourceRepositoryDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(SourceRepositoryDb.class));
