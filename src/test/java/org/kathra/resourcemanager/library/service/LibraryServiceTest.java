 ...
 *
 * Auto-generated by resource-db-generator@1.0.0 at 2019-01-09T11:09:52.580Z
...
public class LibraryServiceTest {
    ...
    public void beforeEach(){
        ...
        underTest = new LibraryService(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        Library excepted = new Library();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<Library> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        ...
        List<Library> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        Library objectFull = copy(object);
        ...
        ArgumentCaptor<Library> objectCaptor = ArgumentCaptor.forClass(Library.class);
        ...
        Library objectCaptured = objectCaptor.getValue();
