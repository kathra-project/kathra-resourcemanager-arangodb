 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T18:48:13.561Z
...
public class PipelineDaoTest {
    ...
    public void beforeEach(){
		underTest.sourceRepositoryPipelineEdgeRepository = sourceRepositoryPipelineEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(Pipeline.class, PipelineDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        PipelineDb objectDb = new PipelineDb();
        ...
        PipelineDb objectDbCaptured = (PipelineDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(PipelineDb.class));
