...
package org.kathra.resourcemanager.asset.dao;
...
import org.kathra.resourcemanager.asset.dao.AssetDao;
import org.kathra.resourcemanager.asset.dao.AssetDb;
import org.kathra.resourcemanager.asset.dao.AssetRepository;
...
import org.kathra.resourcemanager.binaryrepository.dao.BinaryRepositoryAssetEdge;
import org.kathra.resourcemanager.binaryrepository.dao.BinaryRepositoryAssetEdgeRepository;
import org.kathra.resourcemanager.sourcerepository.dao.SourceRepositoryAssetEdge;
import org.kathra.resourcemanager.sourcerepository.dao.SourceRepositoryAssetEdgeRepository;
import org.kathra.resourcemanager.pipeline.dao.PipelineAssetEdge;
import org.kathra.resourcemanager.pipeline.dao.PipelineAssetEdgeRepository;
import org.kathra.resourcemanager.catalogentry.dao.CatalogEntryAssetEdge;
import org.kathra.resourcemanager.catalogentry.dao.CatalogEntryAssetEdgeRepository;


/**
 * Class testing AssetsDao
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T12:41:28.412Z
...
public class AssetDaoTest {
	...
	@Mock
	BinaryRepositoryAssetEdgeRepository binaryRepositoryAssetEdgeRepository;
	@Mock
	SourceRepositoryAssetEdgeRepository sourceRepositoryAssetEdgeRepository;
	@Mock
	PipelineAssetEdgeRepository pipelineAssetEdgeRepository;
	@Mock
	CatalogEntryAssetEdgeRepository catalogEntryAssetEdgeRepository;
    ...
    public void beforeEach(){
		underTest.binaryRepositoryAssetEdgeRepository = binaryRepositoryAssetEdgeRepository;
		underTest.sourceRepositoryAssetEdgeRepository = sourceRepositoryAssetEdgeRepository;
		underTest.pipelineAssetEdgeRepository = pipelineAssetEdgeRepository;
		underTest.catalogEntryAssetEdgeRepository = catalogEntryAssetEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(Asset.class, AssetDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        AssetDb objectDbCaptured = (AssetDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(AssetDb.class));
