...
package org.kathra.resourcemanager.asset.service;
 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T11:49:45.961Z
...
public class AssetServiceTest {
    ...
    public void beforeEach(){
        ...
        underTest = new AssetService(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        Asset excepted = new Asset();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<Asset> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        List<Asset> excepted = ImmutableList.of(new Asset().id("5sf76zf4raezf3z"), new Asset().id("5sf7sd4qsd46q"));
        Mockito.when(dao.findAll()).thenReturn(excepted);
        List<Asset> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        ArgumentCaptor<Asset> objectCaptor = ArgumentCaptor.forClass(Asset.class);
        ...
        Asset objectCaptured = objectCaptor.getValue();
