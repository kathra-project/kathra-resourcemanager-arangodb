 ...
 *
 * Auto-generated by resource-db-generator@1.0.1 at 2019-03-13T09:44:39.587Z
...
public class KeyPairServiceTest {
    ...
    public void beforeEach(){
        ...
        underTest = new KeyPairService(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        KeyPair excepted = new KeyPair();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<KeyPair> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        List<KeyPair> excepted = ImmutableList.of(new KeyPair().id("5sf76zf4raezf3z"), new KeyPair().id("5sf7sd4qsd46q"));
        Mockito.when(dao.findAll()).thenReturn(excepted);
        List<KeyPair> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        KeyPair objectFull = copy(object);
        ...
        ArgumentCaptor<KeyPair> objectCaptor = ArgumentCaptor.forClass(KeyPair.class);
        ...
        KeyPair objectCaptured = objectCaptor.getValue();
