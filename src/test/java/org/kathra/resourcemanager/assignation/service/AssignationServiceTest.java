 ...
 *
 * Auto-generated by resource-db-generator@1.0.0 at 2019-01-09T11:09:56.318Z
...
public class AssignationServiceTest {
    ...
    public void beforeEach(){
        ...
        underTest = new AssignationService(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        Assignation excepted = new Assignation();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<Assignation> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        ...
        List<Assignation> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        Assignation objectFull = copy(object);
        ...
        ArgumentCaptor<Assignation> objectCaptor = ArgumentCaptor.forClass(Assignation.class);
        ...
        Assignation objectCaptured = objectCaptor.getValue();
