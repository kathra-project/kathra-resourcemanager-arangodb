 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T13:40:33.933Z
 * @author jboubechtoula
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class CatalogEntryDaoTest {

    @InjectMocks
    CatalogEntryDao underTest;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(CatalogEntry.class, CatalogEntryDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        CatalogEntryDb objectDb = new CatalogEntryDb();
        ...
        CatalogEntryDb objectDbCaptured = (CatalogEntryDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(CatalogEntryDb.class));
