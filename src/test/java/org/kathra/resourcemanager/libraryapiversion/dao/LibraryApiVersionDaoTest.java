 ...
 *
 * Auto-generated by resource-db-generator@1.3.0 at 2019-12-28T18:27:36.401Z
 * @author Julien Boubechtoula
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class LibraryApiVersionDaoTest {

    @InjectMocks
    LibraryApiVersionDao underTest;
    ...
    @Mock
    LibraryApiVersionRepository repository;
    @Mock
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(LibraryApiVersion.class, LibraryApiVersionDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        LibraryApiVersionDb objectDb = new LibraryApiVersionDb();
        ...
        LibraryApiVersionDb objectDbCaptured = (LibraryApiVersionDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(LibraryApiVersionDb.class));
