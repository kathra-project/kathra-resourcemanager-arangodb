 ...
 *
 * Auto-generated by resource-db-generator@1.2.0 at 2019-12-26T23:49:10.425Z
 * @author Julien Boubechtoula
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class CatalogEntryPackageServiceTest {

    CatalogEntryPackageService underTest;

    @Mock
    CatalogEntryPackageDao dao;
    @Mock
    ...
    public void beforeEach(){
        ...
        underTest = new CatalogEntryPackageService(dao, sessionService);
    }
    ...
    public void given_objectId_when_findById_then_works() throws Exception {
        CatalogEntryPackage excepted = new CatalogEntryPackage();
        Mockito.when(dao.findById("1789")).thenReturn(Optional.of(excepted));
        Optional<CatalogEntryPackage> returned = underTest.findById("1789");
    ...
    public void given_nothing_when_findAll_then_works() throws Exception {
        List<CatalogEntryPackage> excepted = ImmutableList.of(new CatalogEntryPackage().id("5sf76zf4raezf3z"), new CatalogEntryPackage().id("5sf7sd4qsd46q"));
        Mockito.when(dao.findAll()).thenReturn(excepted);
        List<CatalogEntryPackage> returned = underTest.findAll();
    ...
    public void given_partialObject_when_patch_then_return_fullObject() throws Exception {
        ...
        CatalogEntryPackage objectFull = copy(object);
        ...
        ArgumentCaptor<CatalogEntryPackage> objectCaptor = ArgumentCaptor.forClass(CatalogEntryPackage.class);
        ...
        CatalogEntryPackage objectCaptured = objectCaptor.getValue();
