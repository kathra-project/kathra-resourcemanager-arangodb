...
/**
 * Class testing CatalogEntryPackagesDao
 *
 * Auto-generated by resource-db-generator@1.3.0 at 2019-12-28T18:27:12.905Z
 * @author Julien Boubechtoula
 */
@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class CatalogEntryPackageDaoTest {

    @InjectMocks
    CatalogEntryPackageDao underTest;
    ...
    @Mock
    CatalogEntryPackageRepository repository;
    @Mock
    ...
    public void beforeEach(){
		underTest.catalogEntryPackageCatalogEntryEdgeRepository = catalogEntryPackageCatalogEntryEdgeRepository;
		underTest.catalogEntryPackageBinaryRepositoryEdgeRepository = catalogEntryPackageBinaryRepositoryEdgeRepository;
		underTest.sourceRepositoryCatalogEntryPackageEdgeRepository = sourceRepositoryCatalogEntryPackageEdgeRepository;
		underTest.pipelineCatalogEntryPackageEdgeRepository = pipelineCatalogEntryPackageEdgeRepository;
    ...
    public void check_convertion_test() throws Exception {
        new MappingTestUtils().testMappingClasses(CatalogEntryPackage.class, CatalogEntryPackageDb.class, underTest);
    }
    ...
    public void given_object_when_create_then_work() throws Exception {
        ...
        CatalogEntryPackageDb objectDb = new CatalogEntryPackageDb();
        ...
        CatalogEntryPackageDb objectDbCaptured = (CatalogEntryPackageDb) valuesCaptured.get(1);
        ...
        Mockito.verify(operations).insert(Mockito.any(CatalogEntryPackageDb.class));
